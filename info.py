...
API_ID = int(environ.get('API_ID', '11560049'))
API_HASH = environ.get('API_HASH', '0772a78440e20fe74b7fe952b7fed1db')
BOT_TOKEN = environ.get('BOT_TOKEN', "1755036029:AAHsI2fvglK6Sz8oKiUZeFKGVfV9KZktDx8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5291606032', '1115053159', '1785368472', '1119115151').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001645540092', '-1001446583785', '-1001582302762', '-1001188785497', '-1001368488500', '-1001589244933', '-1001608509389',).split()]
...
SHORTENER_API = environ.get("SHORTENER_API", "e12f3ab934008565cde6b52029dfca25e7fdd3f6")
